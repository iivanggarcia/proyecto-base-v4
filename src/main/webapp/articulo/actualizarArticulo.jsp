...
<html>
    ...
    <body>
        <div class="container">
            ...
            <h1>
                Formulario de Actualización de Articulo
            </h1>
            
            <!-- Lo procesará un SERVLET con el PARÁMETRO acción se decide a dónde ir-->
            <form method="post" action="ArticuloServlet?accion=actualizarDatos">
                <div class="mb-3">
                    <label for="a" class="form-label">Id del articulo: </label>
                    <input type="text" class="form-control" name="idArt" id="a" placeholder="Ingrese el nombre"
                           value="${dtoArt.entidad.idArticulo}"
                           readonly
                           required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nombre" id="a" placeholder="Ingrese el nombre"
                           value="${dtoArt.entidad.nombreArticulo}"
                           required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="descripcion" id="b" placeholder="Ingrese el nuevo correo"
                           value="${dtoArt.entidad.descripcionArticulo}"
                           required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="existencia" id="c" placeholder="Ingrese el nuevo correo"
                           value="${dtoArt.entidad.existencias}"
                           required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="stockMin" id="d" placeholder="Ingrese el nuevo correo"
                           value="${dtoArt.entidad.stockMinimo}"
                           required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="stockMax" id="e" placeholder="Ingrese el nuevo correo"
                           value="${dtoArt.entidad.stockMaximo}"
                           required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="categoria" id="e" placeholder="Ingrese el nuevo correo"
                           value="${dtoArt.entidad.idCategoria}"
                           required>
